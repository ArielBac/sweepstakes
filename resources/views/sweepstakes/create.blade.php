                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="description" id="description"
                                   ...
                                   shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="text-xs text-red-300">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input value="{{ old('number_of_winners') }}" type="number" name="number_of_winners"
