                ...
                <li class="relative col-span-1 flex rounded-md shadow-sm">
                    ...
                    <div
                        ...
                        <div class="flex-1 truncate px-4 py-2 text-sm">
                            <a href="{{ route('sweepstakes.show', $sweepstake) }}"
                                class="font-medium text-gray-900 hover:text-gray-600">{{ $sweepstake->title }}</a>
                    ...
                    @foreach ($sweepstakes as $sweepstake)
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-6 py-3 text-right text-sm font-medium">
                                <a href="{{ route('sweepstakes.edit', $sweepstake->id) }}"
