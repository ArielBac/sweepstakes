            ...
            <div
                ...
                @if (session('success'))
                    <div class="p-2 flex flex-row items-center bg-green-100 rounded-lg border border-green-300 gap-x-1">
                        ...
                        <span class="text text-sm">{{ session('success') }}</span>
                    </div>
                @endif
                ...
                <form action="{{ route('sweepstake.storeParticipant', $sweepstake->id) }}"
                    ...
                    <div class="col-span-6">
                        ...
                        <input value="{{ old('name') }}" placeholder="Nome completo" type="text" name="name"
                    ...
                    <div class="col-span-6">
                        ...
                        <input value="{{ old('email') }}" placeholder="email@email.com" type="text" name="email"
                    ...
                    <div class="w-fit bg-gray-50 py-3 text-right">
                        <button type="submit"
