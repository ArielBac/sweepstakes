                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd>
                                    <div class="text-lg font-medium text-gray-900">{{ $sweepstake->participants->count() }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <div class="text-lg font-medium text-gray-900">
                                        {{ $sweepstake->end_date->format('d/m/Y') }}</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    @foreach ($sweepstake->participants as $participant)
                        <tr>
                            ...
                            <td class="hidden whitespace-nowrap px-6 py-3 text-right text-sm text-gray-500 md:table-cell">
                                {{ !empty($participant->awarded_at) ? $participant->awarded_at->format('d/m/Y') : '' }}
                            </td>
